...
public class PurchaseInsurance_PahrOhneKids extends Base {
	 ...
	 public static Logger log =LogManager.getLogger(PurchaseInsurance_PahrOhneKids.class.getName());
	@BeforeMethod
	...
	public void Purchase_PrivateIns_PahrOhneKids_PublicServant_YesDeductible() throws Throwable
	{
		...
		ArrayList<String>testdata=eu.GetTestData("TC13");
	...
	public void Purchase_PrivateIns_PahrOhneKids_PublicServant_NoDeductible() throws Throwable
	{
		...
		String iBAN=prop.getProperty("IBAN");
		ExcelUtility eu=new ExcelUtility();
		ArrayList<String>testdata=eu.GetTestData("TC14");
		Actions a =new Actions(driver);
		driver.manage().timeouts().implicitlyWait(20,TimeUnit.SECONDS); 
		StartDatePage start=new StartDatePage(driver);
		BankDetailsPage bd=new BankDetailsPage(driver);
	...
	public void Purchase_PrivateIns_PahrOhneKids_NotPublicServant_YesPensionar_YesDeductible() throws Throwable
	{
		...
		String iBAN=prop.getProperty("IBAN");
		ExcelUtility eu=new ExcelUtility();
		ArrayList<String>testdata=eu.GetTestData("TC15");
		Actions a =new Actions(driver);
		driver.manage().timeouts().implicitlyWait(20,TimeUnit.SECONDS); 
		StartDatePage start=new StartDatePage(driver);
		BankDetailsPage bd=new BankDetailsPage(driver);
	...
	public void Purchase_PrivateIns_PahrOhneKids_NotPublicServant_YesPensionar_NoDeductible() throws Throwable
	{
		...
		String iBAN=prop.getProperty("IBAN");
		ExcelUtility eu=new ExcelUtility();
		ArrayList<String>testdata=eu.GetTestData("TC16");
		Actions a =new Actions(driver);
		driver.manage().timeouts().implicitlyWait(20,TimeUnit.SECONDS); 
		StartDatePage start=new StartDatePage(driver);
		BankDetailsPage bd=new BankDetailsPage(driver);
	...
	public void Purchase_PrivateIns_PahrOhneKids_NotPublicServant_NotPensionar_YesDeductible() throws Throwable
	{
		...
		String iBAN=prop.getProperty("IBAN");
		ExcelUtility eu=new ExcelUtility();
		ArrayList<String>testdata=eu.GetTestData("TC17");
		Actions a =new Actions(driver);
		driver.manage().timeouts().implicitlyWait(20,TimeUnit.SECONDS); 
		StartDatePage start=new StartDatePage(driver);
		BankDetailsPage bd=new BankDetailsPage(driver);
	...
	public void Purchase_PrivateIns_PahrOhneKids_NotPublicServant_NotPensionar_NotDeductible() throws Throwable
	{
		...
		String iBAN=prop.getProperty("IBAN");
		ExcelUtility eu=new ExcelUtility();
		ArrayList<String>testdata=eu.GetTestData("TC18");
		Actions a =new Actions(driver);
		driver.manage().timeouts().implicitlyWait(20,TimeUnit.SECONDS); 
		StartDatePage start=new StartDatePage(driver);
		BankDetailsPage bd=new BankDetailsPage(driver);
